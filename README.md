...
Motivated Computer Science undergraduate specializing in full-stack development with proficiency in JavaScript, React.js, Node.js, Express.js, MongoDB, and Docker, seeking Software Engineer or SDE roles. Experienced in building scalable RESTful APIs, AI-integrated web applications, and CI/CD pipelines, with strong foundations in Data Structures, Algorithms, and System Design.
...
- Engineering a code-aware RAG pipeline utilizing OpenAI API embeddings and Qdrant, improving AI-assisted code suggestions and decreasing average response times by **25%** through custom SSE pipeline
- Orchestrating containerization of all services using Docker and docker-compose, streamlined CI/CD through GitHub Actions and Nginx reverse proxy — resulting in **30% faster deployment**
- **Tech Stack:** Next.js, Redis, WebSockets, Socket.io, Yjs, OpenAI API, Qdrant, Vercel AI SDK, Docker
...
| Category | Skills |
|:---|:---|
| Languages | C++, JavaScript (ES6+), Python, SQL, TypeScript |
| Frontend | HTML, CSS, React.js, Next.js, Framer Motion, Responsive Design |
| Backend | Node.js, Express.js, RESTful APIs, JWT Auth, Authentication & Authorization |
| Databases | MySQL, MongoDB, PostgreSQL |
| DevOps & Tools | Git, GitHub, Docker, CI/CD, Microservices, System Design, AI Integration |
...
- Engineered an interactive **Power BI dashboard** for patient risk analysis, pinpointing 3 crucial health indicators and decreasing time spent on manual risk assessments by **20%**
- Implemented version control using Git for data workflows, facilitating seamless collaboration among up to **4 team members**
- **Tools:** Python, SQL, Power BI, Git

**UPI Transactions Data Analysis Dashboard** &nbsp;|&nbsp; <a href="https://github.com/ShivGupta12234" target="_blank" rel="noopener noreferrer">GitHub</a> &nbsp;|&nbsp; `Apr '25`

- Conducted rigorous data profiling, cleansing, and transformation of UPI transaction data within Power BI, increasing data accuracy by **18%**
- Investigated **20+ variables** using EDA and statistical methods, pinpointing **5 key indicators** linked to cardiovascular risk, improving risk assessment
- Built user-friendly visualizations (bar charts, line charts, pie charts, KPI cards) for stakeholder accessibility
- Developed an interactive Power BI dashboard with **8+ visuals**
- **Technologies:** Microsoft Power BI, Python, Microsoft SQL, Microsoft Excel
...
| Data Analysis | Data Cleaning, Data Wrangling, Data Transformation, Data Quality, SEO Analysis |
| Libraries | NumPy, Pandas, Matplotlib, Seaborn, Scikit-Learn |
| Statistics & ML | Statistical Analysis, Regression Analysis, EDA |
| Databases | SQL, PostgreSQL, Data Modeling |
| Tools | Microsoft Excel, Google Sheets, Power BI, Data Visualization |
...
![CI/CD](https://img.shields.io/badge/CI%2FCD-0A0A0A?style=for-the-badge&logo=githubactions&logoColor=00d4ff)
![Microservices](https://img.shields.io/badge/Microservices-7928ca?style=for-the-badge&logo=serverless&logoColor=white)
![AI Integration](https://img.shields.io/badge/AI_Integration-FF4C8B?style=for-the-badge&logo=openai&logoColor=white)
...
![Data Cleaning](https://img.shields.io/badge/Data_Cleaning-00d4ff?style=for-the-badge&logo=databricks&logoColor=white)
![Data Wrangling](https://img.shields.io/badge/Data_Wrangling-7928ca?style=for-the-badge&logo=databricks&logoColor=white)
![EDA](https://img.shields.io/badge/EDA-FF6B35?style=for-the-badge&logo=chartdotjs&logoColor=white)
![Power BI](https://img.shields.io/badge/Power_BI-F2C811?style=for-the-badge&logo=powerbi&logoColor=black)
![SEO Analysis](https://img.shields.io/badge/SEO_Analysis-34A853?style=for-the-badge&logo=google&logoColor=white)
...
![Statistical Analysis](https://img.shields.io/badge/Statistical_Analysis-FF4C8B?style=for-the-badge&logo=scipy&logoColor=white)
![Regression Analysis](https://img.shields.io/badge/Regression_Analysis-00d4ff?style=for-the-badge&logo=chartdotjs&logoColor=white)
